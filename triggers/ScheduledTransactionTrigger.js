...
function ScheduledTransaction() {
  ScheduledTransaction.super_.call(this, 'scheduled_transaction');
}
util.inherits(ScheduledTransaction, Ifttt.Trigger);

// Overwrite `_getResponseData` with your response handler.
ScheduledTransaction.prototype._getResponseData = async function(
  req,
  requestPayload,
  cb
) {
